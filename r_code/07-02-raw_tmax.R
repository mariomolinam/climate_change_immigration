...
#       and then average over months.
write.csv( x = crude_weather_yearly(data=tmax.mmp, weather="tmax", operation="above30-consecutive"),
           file = "./mmp_data/crude_above30-tmax_yearly-consecutive_mmp_1980-2017.csv", row.names = FALSE)
